...
class SemanticError : public std::exception {
  ...
  public:
    SemanticError(Location p_loc, std::string p_reason): reason(genReason(p_loc, p_reason)) {}
...
class IncompatibleParamError : public SemanticError {
  public:
	IncompatibleParamError(Location loc, TypePtr type_of_argument, TypePtr type_of_parameter):
    	SemanticError(
        	loc,
...
class IncompatibleAssignError : public SemanticError {
  public:
	IncompatibleAssignError(Location loc, TypePtr type_of_variable_reference, TypePtr type_of_expression):
    	SemanticError(
        	loc,
...
class ReturnTypeError : public SemanticError {
  public:
	ReturnTypeError(Location loc, TypePtr type_of_expression, TypePtr return_type):
    	SemanticError(
        	loc,
